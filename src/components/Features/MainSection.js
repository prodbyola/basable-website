    ...
    <div className="mainSection">
      ...
      <div className="mainSectionColumn2">
        <div className="section2">
          <img src={enhanced.src} alt="Enhanced collaboration" id="enhancedImage" />
      ...
      <div className="section4">
        ...
        <img src={action.src} alt=" Actionable Business Insight" id="actionImage" />
      </div>
    </div>
  );
}
